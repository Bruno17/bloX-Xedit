...
var MooInline = new Class({
	...
	initialize: function(selectors, options){
		...
		els.each(function(el, index){
			...
			if(l=='b' || l=='t' || !l) el.set('contentEditable', true);//.focus();removed by Bruno
	...
	insertToolbar: function (pos){
		var mi = new Element('div', {'id':'rte','class':'miRemove miMooInline '+(!pos||pos=='n'?'miHide':''), 'contentEditable':false }).adopt(
